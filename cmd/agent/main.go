// Package main implements Package Updates for Zabbix Agent 2.
package main
...
import (
	...
	"github.com/obviousaichicken/zabbix-agent2-plugin-package-updates/internal/logging"
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "zabbix-agent2-plugin-package-updates: %v\n", err)
		os.Exit(1)
	}
}
